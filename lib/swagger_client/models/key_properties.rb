...
module SwaggerClient
  ...
  class KeyProperties
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'exportable')
      ...
      if attributes.has_key?(:'reuse_key')
        self.reuse_key = attributes[:'reuse_key']
      end
    ...
    def hash
      [exportable, kty, key_size, reuse_key, crv].hash
    end
