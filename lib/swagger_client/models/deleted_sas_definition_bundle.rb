...
module SwaggerClient
  ...
  class DeletedSasDefinitionBundle
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sasType')
        self.sas_type = attributes[:'sasType']
      end
    ...
    def valid?
      sas_type_validator = EnumAttributeValidator.new('String', ['account', 'service'])
      return false unless sas_type_validator.valid?(@sas_type)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] sas_type Object to be assigned
    def sas_type=(sas_type)
      validator = EnumAttributeValidator.new('String', ['account', 'service'])
      unless validator.valid?(sas_type)
        fail ArgumentError, 'invalid value for "sas_type", must be one of #{validator.allowable_values}.'
      end
      @sas_type = sas_type
    end
    ...
    def hash
      [id, sid, template_uri, sas_type, validity_period, attributes, tags, recovery_id, scheduled_purge_date, deleted_date].hash
    end
