...
module SwaggerClient
  ...
  class SasDefinitionCreateParameters
    ...
    def list_invalid_properties
      ...
      if @template_uri.nil?
        invalid_properties.push('invalid value for "template_uri", template_uri cannot be nil.')
      end

      if @sas_type.nil?
        invalid_properties.push('invalid value for "sas_type", sas_type cannot be nil.')
      end
    ...
    def valid?
      return false if @template_uri.nil?
      return false if @sas_type.nil?
    ...
    def hash
      [template_uri, sas_type, validity_period, attributes, tags].hash
    end
